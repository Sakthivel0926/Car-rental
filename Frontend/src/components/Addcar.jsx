...
const Addcar = ({ onCarAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://car-rental-2-w085.onrender.com/api/cars", {
        method: "POST",
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-300 to-red-300 p-4">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2 drop-shadow-lg">Add Your Dream Car</h1>
        </div>
